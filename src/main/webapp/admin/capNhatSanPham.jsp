    ...
    <div class="row">
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
            <div class="container_form">
                <form class="form-container" action="../admin?action=updateProduct&productId=${product.id}" method="post"
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="productName"
                               name="productName" placeholder="Nhập tên sản phẩm" value="${product.name}">
                    ...
                    <div class="mb-3">
                        <label for="weight" class="form-label">Trọng Lượng</label> <input
                            ...
                            placeholder="Nhập trọng lượng" value="${product.weight}" >
                    </div>
